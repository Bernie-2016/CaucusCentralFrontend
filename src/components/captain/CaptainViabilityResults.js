      ...
      <div className="container-fluid text-center
        ...
        <div className="row">
          <div className="col-xs-12">
            { to_become_viable }
            <p className="delegate-text">There are currently { parseInt(this.props.delegates) } delegates for Bernie</p>
            <p className="delegate-text">To get 1 more delegate you need { this.props.oneMore } people</p>
            <p className="delegate-text">To get 2 more delegates you need { this.props.twoMore } people</p>
          </div>
        </div>
